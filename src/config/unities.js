...
export const unitiesPT = [
  ...
  },
  {
    ...
    unityDesc:
      "Startup Porto A Startup Porto tem como objetivo promover o surgimento e o desenvolvimento de uma nova geração de negócios, promovendo programas de empreendedorismo, não apenas para o ecossistema do Porto, mas para todo o país. O nosso objetivo é facilitar o processo entre a imaginação de um produto e a inserção do mesmo no mercado. Para isso, oferecemos uma ampla gama de programas, como pré-aceleração, aceleração e eventos para interligar empreendedores e investidores, que terão como alvo diferentes estágios de desenvolvimento.",
    content:
      "A Startup Porto tem como objetivo promover o surgimento e o desenvolvimento de uma nova geração de negócios, promovendo programas de empreendedorismo, não apenas para o ecossistema do Porto, mas para todo o país. O nosso objetivo é facilitar o processo entre a imaginação de um produto e a inserção do mesmo no mercado. Para isso, oferecemos uma ampla gama de programas, como pré-aceleração, aceleração e eventos para interligar empreendedores e investidores, que terão como alvo diferentes estágios de desenvolvimento. É essencial haver um espaço de rede entre startups, indústria e educação, e por essa mesma razão, a Startup Porto ambiciona criar esse elo através do nosso processo de incubação e parcerias com outras redes similares tais como as Innovation Hubs. O que pretendemos atingir com a Startup Porto é: - Indústrias criativas; - Economia circular e CLEANTECH; - ETECH; - FINTECH; - Cuidados de saúde; - Hospitalidade e turismo (e novos alimentos); - Indústria 4.0; - Economia Social. "
  },
  {
    id: 3,
    imageUrl:
...
export const unitiesEN = [
  ...
  },
  {
    ...
    unityName: "Porto Business Innovation",
    unityDesc:
      "Porto Business Innovation (PBI) is a connection between academia, business reality, society and public administrations. Based on knowledge and process innovation, Porto Business Innovation aims to promote new business opportunities and develop new products and services to reach the market quickly.",
    content: `
      ...
      <br>
      <ul>
        <li>Wood based prototyping;</li>
        <li>3D and 2D printing;</li>
        <li>Introduction workshops to various subjects;</li>
        <li>Project consulting;</li>
        <li>Electronics;</li>
        <li>Reservation of daily workshops;</li>
        <li>Complementary training.</li>
      </ul>
      `
  }
];

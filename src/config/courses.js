...
export const courses = [
  {
    ...
    courseDesc: `O <span>ME310 Porto</span> é uma Pós-Graduação em Product Innovation, de natureza interdisciplinar, “project-based” e “team-based”, para estudantes com licenciatura ou mestrado concluídos, que representa uma verdadeira integração entre engenharia, ciências empresariais e design. Esta pós-graduação foi criada, originalmente, na Universidade de Stanford e funciona há mais de 40 anos. O curso está focado em ensinar aos estudantes os métodos de inovação e os processos necessários para designers, engenheiros e gestores de projetos de inovação do futuro. Após a conclusão do curso, os alunos adquirirão as competências necessárias para serem líderes globais de inovação.
      ...
      <br>
      <br>
      <span>ME310 is all hands-on, all the time.</span>`
  },
  {
    id: 2,
  ...
  },
  {
    ...
    courseDesc: `
      ...
      <ul>
        ...
        <li>Modelos de negócios;</li>
        <li>Desenvolvimento UI/UX;</li>
        <li>Processos agile/lean;</li>
        <li>Tecnologias emergentes para a criação de experiências;</li>
        <li>Processos de design centrados no ser humano;</li>
        <li>Criação, seleção e desenvolvimento de ideias;</li>
        <li>Psicologia comportamental.</li>
      </ul>
      <br>
      <br>
      <span>Duração</span>
  ...
  },
  {
    ...
    courseDesc: `
      ...
      <br>
      <br>
      <span>Objetivos do plano:</span>
      <br>
      <ul>
        <li>Aplicar métodos de pesquisa de design no sentido de comunicar a resolução criativa de problemas visando o aumento do impacto da ciência ou da pesquisa baseada em tecnologia;</li>
        <li>Avaliar a natureza de uma ciência ou tecnologia e articular as suas potenciais características que poderiam beneficiar ou trazer valor a uma aplicação delineada;</li>
        <li>Contribuir para uma cultura de inovação através de estratégias mais básicas, tais como a tomada de decisão, utilização de diferentes abordagens e diferentes pontos de vista em atividades colaborativas;</li>
        <li>Implementar uma variedade de métodos de inovação para explorar ideias de design destinadas a aumentar o valor na sociedade e / ou comercial de uma peça específica de ciência ou tecnologia;</li>
        <li>Adquirir experiência de diferentes fontes necessárias para colmatar eventuais lacunas de conhecimento na compreensão da viabilidade, desejabilidade e viabilidade das aplicações propostas para pesquisa científica e tecnológica;</li>
        <li>Comunicar efetivamente a uma ampla audiência, o valor de diferentes pesquisas científicas e tecnológicas, usando técnicas visuais adequadas;</li>
        <li>Apresentar os resultados holísticos do projeto com o objetivo de aumentar o valor na sociedade e/ou comercial de um projeto específico de pesquisa e desenvolvimento relacionado com a ciência e/ou tecnologia;</li>
        <li>Definir estratégias de implementação, incluindo a identificação de pesquisas e desenvolvimentos futuros necessários, para executar os resultados desenvolvidos para pesquisa científica e/ou tecnológica.</li>
      </ul>
      <br>
      <br>
      <br>
      <span>Entregas e Resultados finais:</span>
      <br>
      <ul>
        <li>Documentação do progresso do projeto em vídeo;</li>
        <li>Diário acerca do desenvolvimento de ideias, incluindo testes a utilizadores;</li>
        <li>Relatório final e protótipo que demonstram e justificam os resultados projetados e o plano de implementação;</li>
        <li>Apresentação final e video.</li>
      </ul>
      `
  },
  {
    id: 5,
    courseName: "FORMAÇÃO CO-CRIAÇÃO",
    courseDesc: `

<template>
  <div class="admin_users__popup admin_delete_popup">
    <h2>
      Tem a certeza que pretende bloquear o colaborador<br />
      <span>{{ userName }}</span>
    </h2>
...
export default {
  ...
  computed: {
    ...mapGetters(["getSelectedUserByID", "getUserByID"])
  },
  methods: {
    closePopup() {

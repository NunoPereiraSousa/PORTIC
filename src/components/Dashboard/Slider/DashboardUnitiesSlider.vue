<template>
  <div
    class="admin_unities__slider admin_unities_edit__slider admin_add_slider grid"
  >
...
export default {
  ...
  methods: {
    ...
    closeSlider() {
      let admin_unities__panel__overlay_slide = document.querySelector(
        ".admin_unities__panel__overlay_slide"
      );

      let admin_unities__slider = document.querySelector(
        ".admin_unities_edit__slider"
      );

      admin_unities__panel__overlay_slide.classList.toggle(
        "show_overlay_slide"
      );
      admin_unities__slider.classList.toggle("show_slider");
    },
    save() {
